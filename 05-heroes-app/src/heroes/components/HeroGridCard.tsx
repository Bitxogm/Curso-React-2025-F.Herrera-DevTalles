...
export const HeroGridCard: React.FC<Props> = ({ hero }) => {
  ...
  return (
    ...
    {
      (hero.universe === 'DC' ) ?
        <Badge className="absolute top-3 right-3 text-xs bg-blue-800 text-white">{hero.universe}</Badge>
      :
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <Progress value={hero.strength * 10} className="h-2 bg-gray-400 [&>div]:bg-orange-500" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={hero.intelligence * 10} className="h-2 bg-gray-300 [&>div]:bg-blue-500" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={hero.speed * 10} className="h-2 bg-gray-300 [&>div]:bg-green-500" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={hero.durability * 10} className="h-2 bg-gray-300 [&>div]:bg-purple-500" />
          </div>
        </div>

        {/* Powers */}
        <div className="space-y-2">
          <h4 className="font-medium text-sm">Powers: {hero.powers.length}</h4>
