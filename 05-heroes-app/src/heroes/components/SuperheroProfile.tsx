          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="relative">
              <img
                ...
                className="w-48 h-48 md:w-56 md:h-56 object-cover rounded-full border-4 border-white/20 shadow-2xl"
                onError={(e) => {
                  e.currentTarget.src = "https://via.placeholder.com/200?text=Hero";
                }}
              />
