...
export const InstagromApp = () => {
  ...
  const handleAddComment = async (formData: FormData) => {
    // obtenemos el valor del imput de texto del formulario , del name post-message
    ...
    startTransition(async () => {
      ...
      console.log('Id del comentario nuevo :', newComment.id, 'Fecha :', newComment.date, 'Hora :', newComment.time);
    })
  };
