...
export const HeroGridCard: React.FC<Props> = ({ title }) => {
  return (
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  <Progress value={70} className="h-2 bg-gray-400 [&>div]:bg-orange-500" />
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-1">
                  ...
                  <Progress value={80} className="h-2 bg-gray-300 [&>div]:bg-blue-500" />
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-1">
                  ...
                  <Progress value={50} className="h-2 bg-gray-300 [&>div]:bg-green-500" />
                </div>
                <div className="space-y-1">
                  <div className="flex items-center gap-1">
                  ...
                  <Progress value={90} className="h-2 bg-gray-300 [&>div]:bg-purple-500" />
                </div>
              </div>
