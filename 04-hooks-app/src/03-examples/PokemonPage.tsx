...
export const PokemonPage = () => {
  ...
  const {pokemon, isLoading, fomatteId} = usePokemon({id: counter});
 ...
 if (!pokemon) return (
  <div className="bg-gradient flex flex-col items-center">
  <h1 className="text-2xl font-thin text-white">Pokémon</h1>
  <h3 className="text-xl font-bold text-white">No hay pokémon</h3>
  </div>
 )
  ...
  return (
    <div className="bg-gradient flex flex-col items-center">
      <h1 className="text-2xl font-thin text-white">Pokémon</h1>
      <h3 className="text-xl font-bold text-white">{fomatteId} {pokemon?.name}</h3>
      <img
